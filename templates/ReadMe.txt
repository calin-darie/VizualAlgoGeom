...
2. Locate the custom project templates folder. In Visual Studio, navigate to Tools > Options > Projects and Solutions. The folder you're interested in is labeled "User project templates location:"
...
5. Make sure that "Create directory for solution" is checked. Relative paths included in the template depend on this, plus it will make the new algorithm consistent with the old ones. 